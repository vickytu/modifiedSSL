...
public class Node {
    ...
    private void receivePacket(int from, Packet packet) {
        ...
        case Protocol.TRANSPORT_PKT:
            // send to TCPManager
            byte[] transport = packet.getPayload();
            tcpMan.receive(from, transport);
            break;
    ...
    // Adds a timer, to fire in deltaT milliseconds, with a callback to a public function of any class with parameters
    public void addTimer(long deltaT, String methodName, Object obj, int n) {
    try {
